...
export const scenarios = {
  cnc: {
    ...
    severity: 'danger',
    banner: {
      label: '⚠ Disruption detected · 09:35:40',
...
Reason: Unscheduled CNC-2 maintenance event on 14 May at 09:35
...
— M. Reyes, Production Planning, Meridian Plant 04`,
    audit: [
      ['09:35:40', 'Disruption detected', 'MES event · CNC-2 spindle overtemp E-237'],
      ['09:35:52', 'Solver returned', '17 feasible options · DPAS hierarchy enforced'],
      ['09:36:04', '3 options surfaced', 'A (hold), B (reroute), C (Saturday shift)'],
      ['09:37:18', 'Option {OPT} accepted', 'by M. Reyes · auto-execute initiated'],
      ['09:37:19', 'Schedule committed', 'to MES · floor displays updated · notification drafted'],
    ],
  },
